...
def test_quando_nome_possuir_mais_que_2_e_menos_que_51_caracteres_deve_ser_valido() -> None:
...
def test_quando_first_name_possuir_menos_que_3_caracteres_deve_ser_invalido() -> None:
    nome = Name("Sr", "Delatorre")
    assert nome.is_valid is False


def test_quando_first_name_possuir_mais_que_50_caracteres_deve_ser_invalido() -> None:
    nome = Name(
...
def test_quando_last_name_possuir_menos_que_3_caracteres_deve_ser_invalido() -> None:
    nome = Name("Emerson", "Jr")
    assert nome.is_valid is False


def test_quando_last_name_possuir_mais_que_50_caracteres_deve_ser_invalido() -> None:
    nome = Name(
