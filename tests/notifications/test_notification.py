...
class TestNotification:
    ...
    def test_repr_representation(self) -> None:
        ...
        notification = Notification(field="Idade", message="Idade deve ser positiva")
    ...
    def test_str_and_repr_are_equal(self) -> None:
        ...
        notification = Notification(field="Preço", message="Preço deve ser maior que zero")
    ...
    def test_notification_with_special_characters(self) -> None:
        ...
        notification = Notification(field="Código#1", message="Caracteres especiais: @!$%")
