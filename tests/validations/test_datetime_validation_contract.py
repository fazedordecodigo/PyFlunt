...
import pytest
from flunt.validations.datetime_validation_contract import DateTimeValidationContract
...
def test_is_date_before_with_invalid_date(contract: DateTimeValidationContract):
    value = date(2023, 1, 2)
    comparer = date(2023, 1, 1)
    contract.is_date_before(value, comparer, "field", "message")
    assert contract.is_valid is False
...
def test_is_date_between_with_valid_range(contract: DateTimeValidationContract):
    start = date(2023, 1, 1)
    end = date(2023, 1, 3)
    value = date(2023, 1, 2)
...
def test_is_date_between_with_start_boundary(contract: DateTimeValidationContract):
    start = date(2023, 1, 1)
    end = date(2023, 1, 3)
    value = date(2023, 1, 1)
    contract.is_date_between(value, start, end, "field", "message")
...
def test_is_date_between_with_end_boundary(contract: DateTimeValidationContract):
    start = date(2023, 1, 1)
    end = date(2023, 1, 3)
    value = date(2023, 1, 3)
    contract.is_date_between(value, start, end, "field", "message")
...
def test_is_date_between_with_invalid_lower(contract: DateTimeValidationContract):
    start = date(2023, 1, 2)
    end = date(2023, 1, 3)
    value = date(2023, 1, 1)
    contract.is_date_between(value, start, end, "field", "message")
...
def test_is_date_between_with_invalid_upper(contract: DateTimeValidationContract):
    start = date(2023, 1, 1)
    end = date(2023, 1, 2)
    value = date(2023, 1, 3)
    contract.is_date_between(value, start, end, "field", "message")
...
def test_is_date_in_past_with_past_date(mock_get_today, contract: DateTimeValidationContract):
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_date_in_past_with_today(mock_get_today, contract: DateTimeValidationContract):
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_date_in_past_with_future_date(mock_get_today, contract: DateTimeValidationContract):
    mock_get_today.return_value = date(2023, 1, 1)
    value = date(2023, 1, 2)
    contract.is_date_in_past(value, "field", "message")
    assert contract.is_valid is False
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_date_in_past_with_datetime(mock_get_today, contract: DateTimeValidationContract):
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_date_in_future_with_future_date(mock_get_today, contract: DateTimeValidationContract):
    mock_get_today.return_value = date(2023, 1, 1)
    value = date(2023, 1, 2)
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_date_in_future_with_today(mock_get_today, contract: DateTimeValidationContract):
    mock_get_today.return_value = date(2023, 1, 1)
    value = date(2023, 1, 1)
    contract.is_date_in_future(value, "field", "message")
    assert contract.is_valid is False
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_date_in_future_with_past_date(mock_get_today, contract: DateTimeValidationContract):
    mock_get_today.return_value = date(2023, 1, 2)
    value = date(2023, 1, 1)
    contract.is_date_in_future(value, "field", "message")
    assert contract.is_valid is False
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_date_in_future_with_datetime(mock_get_today, contract: DateTimeValidationContract):
    # Should handle datetime by extracting date()
    mock_get_today.return_value = date(2023, 1, 1)
    value = datetime(2023, 1, 2, 12, 0, 0)
    contract.is_date_in_future(value, "field", "message")
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_today_with_today(mock_get_today, contract: DateTimeValidationContract):
    mock_get_today.return_value = date(2023, 1, 1)
    value = date(2023, 1, 1)
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_today_with_not_today(mock_get_today, contract: DateTimeValidationContract):
    mock_get_today.return_value = date(2023, 1, 1)
    value = date(2023, 1, 2)
    contract.is_today(value, "field", "message")
    assert contract.is_valid is False
...
@patch("flunt.validations.datetime_validation_contract._get_today")
def test_is_today_with_datetime(mock_get_today, contract: DateTimeValidationContract):
    # Should handle datetime by extracting date()
    mock_get_today.return_value = date(2023, 1, 1)
    value = datetime(2023, 1, 1, 12, 0, 0)
    contract.is_today(value, "field", "message")
